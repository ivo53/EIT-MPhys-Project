...
class EitBase(object):
    ...
    def __init__(self, mesh, el_pos, f=None, ex_mat=None, step=1, perm=None,
        ...
        if f is None: 
            ...
            try:
                self.J, self.v0, self.B = f.jac, f.v, f.b_matrix
            except:
                raise TypeError("f is not a dictionary of the right type (solve Forward problem!)")
